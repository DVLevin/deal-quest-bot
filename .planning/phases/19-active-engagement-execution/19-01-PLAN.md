...
must_haves:
  truths:
    - "Steps created before Phase 19 load without errors (backward compatible parsing)"
    - "Proof URL persists after upload and page reload"
    - "Uploaded screenshot appears in step details after refresh"
    - "Can't-perform reason is saved and visible after skipping a step"
  artifacts:
