...
In `packages/shared/src/enums.ts` AND `packages/webapp/src/types/enums.ts`, replace the current 5-value LeadStatus with the correct 6 values matching bot/handlers/leads.py STATUS_LABELS:
