...
│   ├── services/
│   │   ├── llm_router.py       # LLM provider abstraction + complete_with_tools() + Langfuse
│   │   ├── conversation_history.py # Per-user sliding window + DB flush (Phase 3)
...
├── data/
│   ├── agents.yaml             # Agent config: defaults + specialist agents (Phase 3)
